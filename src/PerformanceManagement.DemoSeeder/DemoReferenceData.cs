...
public static class DemoReferenceData
{
    ...
    public static readonly (string KpiId, string Name, string Perspective, string Description, string Formula, string DescriptionAr, string FormulaAr)[] Kpis =
    {
        ("KPI001", "Revenue Growth", "F",
            ...
            "يقيس الزيادة السنوية في إجمالي أقساط التأمين المكتتبة.",
            "((إجمالي الأقساط للفترة الحالية − إجمالي الأقساط للفترة السابقة) / إجمالي الأقساط للفترة السابقة) × 100"),
        ("KPI002", "Underwriting Profitability", "F",
            ...
            "يتتبع ربحية نشاط الاكتتاب قبل احتساب دخل الاستثمار.",
            "(الأقساط المكتسبة − المطالبات المتكبدة − مصاريف الاكتتاب) / الأقساط المكتسبة × 100"),
        ("KPI003", "Cost Efficiency Ratio", "F",
            ...
            "يقيس المصاريف التشغيلية كنسبة من الأقساط المكتسبة.",
            "إجمالي المصاريف التشغيلية / الأقساط المكتسبة × 100"),
        ("KPI004", "Investment Return", "F",
            ...
            "العائد المحقق من محفظة الأصول المستثمرة للشركة.",
            "صافي دخل الاستثمار / متوسط الأصول المستثمرة × 100"),
        ("KPI005", "Budget Adherence", "F",
            ...
            "يقيس مدى التزام الإنفاق الفعلي للإدارة بالموازنة السنوية المعتمدة.",
            "(1 − |الإنفاق الفعلي − الإنفاق المعتمد| / الإنفاق المعتمد) × 100"),
        ("KPI006", "Customer Satisfaction Score", "C",
            ...
            "يعكس مستوى رضا العملاء الإجمالي من خلال استبيانات ما بعد التعامل.",
            "متوسط تقييم الاستبيان (على مقياس من 1 إلى 5)، محوّلاً إلى نسبة مئوية"),
        ("KPI007", "Policy Renewal Rate", "C",
            ...
            "نسبة الوثائق المؤهلة التي تم تجديدها عند الاستحقاق.",
            "(عدد الوثائق المجددة / عدد الوثائق المؤهلة للتجديد) × 100"),
        ("KPI008", "Claims Resolution Time", "C",
            ...
            "متوسط عدد الأيام اللازمة لتسوية المطالبة من الإخطار الأول وحتى الدفع.",
            "إجمالي أيام تسوية جميع المطالبات / عدد المطالبات المسواة"),
        ("KPI009", "Net Promoter Score", "C",
            "Measures client willingness to recommend the company.",
            "% Promoters − % Detractors",
            "يقيس مدى استعداد العملاء للتوصية بالشركة.",
            "نسبة المروجين % − نسبة المنتقدين %"),
        ("KPI010", "Cross-Sell Ratio", "C",
            ...
            "متوسط عدد الوثائق المختلفة التي يحملها العميل النشط الواحد.",
            "إجمالي الوثائق السارية / إجمالي العملاء النشطين"),
        ("KPI011", "Process Automation Rate", "I",
            ...
            "نسبة المعاملات التشغيلية المؤهلة التي تمت دون تدخل يدوي.",
            "(المعاملات المؤتمتة / إجمالي المعاملات المؤهلة) × 100"),
        ("KPI012", "Claims Processing Accuracy", "I",
            ...
            "نسبة المطالبات التي تمت معالجتها دون إعادة فتح الحالة أو تصحيح الدفعة.",
            "(المطالبات المعالجة بشكل صحيح / إجمالي المطالبات المعالجة) × 100"),
        ("KPI013", "Risk Exposure Reduction", "I",
            ...
            "الانخفاض في إجمالي التعرض للمخاطر المكتتبة من خلال إعادة التأمين وإجراءات المحفظة.",
            "((التعرض للفترة السابقة − التعرض للفترة الحالية) / التعرض للفترة السابقة) × 100"),
        ("KPI014", "Compliance Adherence", "I",
            ...
            "نسبة نقاط الفحص الداخلية والتنظيمية التي تم اجتيازها دون ملاحظات.",
            "(نقاط الفحص المجتازة / إجمالي نقاط الفحص المدققة) × 100"),
        ("KPI015", "Digital Transformation Progress", "I",
            ...
            "نسبة إنجاز مراحل خارطة الطريق المعتمدة للتحول الرقمي.",
            "(المراحل المنجزة / المراحل المخطط لها) × 100"),
        ("KPI016", "Employee Training Completion", "L",
            ...
            "نسبة إتمام التدريب الإلزامي والتدريب الخاص بالدور الوظيفي في الوقت المحدد.",
            "(التدريبات المكتملة / التدريبات المخصصة) × 100"),
        ("KPI017", "Talent Retention Rate", "L",
            ...
            "نسبة الموظفين المحتفظ بهم خلال فترة المراجعة، باستثناء التناقص المخطط له.",
            "((عدد الموظفين في البداية − حالات المغادرة الطوعية) / عدد الموظفين في البداية) × 100"),
        ("KPI018", "Leadership Development Participation", "L",
            ...
            "نسبة المشاركة في برامج تطوير القيادات وتخطيط التعاقب الوظيفي.",
            "(الموظفون المسجلون / الموظفون المؤهلون) × 100"),
    };
    ...
    public static readonly (string CompId, string Name, string CompType, string Description, string DescriptionAr)[] Competencies =
    {
        ("COM001", "Leadership", "B",
            "Ability to guide, motivate, and develop others toward shared objectives.",
            "القدرة على توجيه الآخرين وتحفيزهم وتطويرهم لتحقيق الأهداف المشتركة."),
        ...
        ("COM012", "Regulatory Knowledge", "T",
            ...
            "الحفاظ على معرفة محدّثة وعملية بأنظمة التأمين ومتطلبات الامتثال المعمول بها."),
    };
