...
public class IndexModel : AppPageModel
{
    ...
    public PerformanceManagement.Core.Domain.PmForm? Form { get; set; }
    ...
    private WorkingSet FromDb(PerformanceManagement.Core.Domain.PmForm? form)
    {
    ...
    private static PerformanceManagement.Core.Domain.PmForm ToValidationForm(WorkingSet w)
    {
        var f = new PerformanceManagement.Core.Domain.PmForm { EmpCode = w.EmpCode, EvalYear = w.EvalYear };
